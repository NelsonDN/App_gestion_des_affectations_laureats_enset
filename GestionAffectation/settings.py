"""
Django settings for GestionAffectation project.
...
SECRET_KEY = 'django-insecure-%(amz@qd1e6@!t03f^5oafz5(a_yap!-_)e49hf(s^e#me-aqk'
...
ROOT_URLCONF = 'GestionAffectation.urls'
...
WSGI_APPLICATION = 'GestionAffectation.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'GestionAffectation/static')
]
