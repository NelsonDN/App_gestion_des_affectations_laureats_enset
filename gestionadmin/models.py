...
class ProfilEtudiant(models.Model):
    ...
    anneeMariage = models.DateField(null=True, blank=True, verbose_name= "Année mariage civil")
    estEffectif = models.BooleanField(null=True, blank=True, verbose_name= "Prise effective Mari valide ?")
    regionRegroupement = models.ForeignKey(DRegion, on_delete=models.CASCADE, null=True, blank=True, verbose_name= "Region regroupement")
